...
// border-radius
const radius = ['0px', '.25rem', '.3rem', '.35rem', '.40rem', '.45rem', '.50rem'];

const borderWidths = ['0px', '1px', '2px', '3px'];

const shadows = {
  viewOptionsBlock: '0 5px 10px 0 rgba(0, 0, 0, 0.1), 0 0 40px 0 rgba(0, 0, 0, 0.1)',
  prospectsDetailsBox: '0 2px 9px 0 rgba(176,192,237,0.42)'
};
